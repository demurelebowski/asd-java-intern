...
public class ReservationService {
    ...
    public List<Reservation> getListByDates(String fromDate, String toDate, String state) {
        return reservationDao.getListByDates(ConverterUtil.localDateFromString(fromDate), ConverterUtil.localDateFromString(toDate), EnumUtils.getEnumIgnoreCase(ReservationState.class, state));
    }
