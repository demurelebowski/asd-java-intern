...
public class ReservationController {
    ...
    @GetMapping("/list")
    public List<ReservationDto> getListByParameters(@RequestParam(name = "product_id") Integer productId, @RequestParam(required = false, name = "organization_id") Integer organizationId, @RequestParam(required = false, name = "agent_id") Integer agentId) {
    ...
    public List<ReservationDto> getListByDates(@RequestParam(name = "from_date") String fromDate, @RequestParam(name = "to_date") String toDate, @RequestParam(required = false, name = "state") String state) {
